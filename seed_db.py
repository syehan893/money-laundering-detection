"""
seed_db.py — Populate MongoDB from Processed Data
====================================================
...
async def seed():
    ...
    # The CSV was sorted by datetime in data_pipeline.py, and graph edges
    # follow the same order. We need to map them.
    df_sorted = df.copy()
    ...
    if num_preds <= num_rows:
        ...
        # More predictions than rows (shouldn't happen, but handle gracefully)
